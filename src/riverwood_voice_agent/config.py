...
DEFAULT_CONFIG_FILENAMES = (
    "riverwood.config.yaml",
    "riverwood.config.yml",
    "riverwood.config.json",
)
...
class Settings:
    ...
    gradio_title: str = "Riverwood AI Voice Agent"
    persona_name: str = "Miss Riverwood"
    persona_description: str = (
        "You are Miss Riverwood -- a warm and friendly AI assistant for Riverwood Projects LLP. "
